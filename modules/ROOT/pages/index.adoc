...
This functionality exists both as a standalone tool as well as a service in the fully managed Neo4j Aura console.
This manual covers the standalone tool.
For information about the import tool in the Aura console, see link:{neo4j-docs-base-uri}/aura/import/introduction[Aura Documentation → Import].
...
include::{ga-promos-uri}/import.adoc[]
