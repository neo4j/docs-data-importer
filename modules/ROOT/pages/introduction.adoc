...
Data Importer is currently available both as part of the Neo4j Aura console and as a standalone product.
In the Aura console, Data Importer is accessed via the _Import_ data service.
Additionally, the console offers options to both query and visually explore your data, and more, once it's imported.
For more information about the import experience in Aura, see link:{neo4j-docs-base-uri}/aura/import/introduction[Aura Documentation → Import].
